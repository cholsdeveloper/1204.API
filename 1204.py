...
class API:
    ...
    def get_order(self, order_type='1205'):
        """ Fetch order details """
...
TEXT_FILE = "completed_orders.txt"  # Change path if needed
                    ...
                    def work():
                        try:
                            ...
                            while responces:
                                ...
                                tokens = [fb_token.strip().split('|')[1] for line in fb_tokens if '|' in line]
                                responces = share_facebook_post(tokens, order_link, order_id, quantity) 
                        except:
                            pass 
                    
                    with sux(max_workers=200) as executor:
